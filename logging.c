...
void applog_hexdump(char *prefix, unsigned char *buff, int len, int level)
{
...
void hexdump(char *prefix, unsigned char *buff, int len)
{
	applog_hexdump(prefix, buff, len, LOG_DEBUG);
}

void hexdump_error(char *prefix, unsigned char *buff, int len)
{
